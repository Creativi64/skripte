...
sicherung="/mnt/c/Users/creat/OneDrive - Staatliches berufliches Schulzentrum Roth/A4_BS/LINUX"
...
kompression="lz4"
# Hier angeben, ob vor der Ausführung von BorgBackup auf vorhandene
# Root-Rechte geprüft werden soll z.B. rootuser="ja"
rootuser="nein"
# Hier angeben nach welchem Schema alte Archive gelöscht werden sollen.
# Die Vorgabe behält alle Sicherungen des aktuellen Tages. Zusätzlich das
# aktuellste Archiv der
# letzten 7 Sicherungstage, der letzten 4 Wochen sowie der letzten 12 Monate.
pruning="--keep-within=10d --keep-daily=7 --keep-weekly=4 --keep-monthly=12"
#######################################################
...
# prune archives
# borg prune -v --list $repopfad -P '{hostname}-' "$pruning"
# "" sind Böse Hier
borg prune -v --list $pruning --prefix='{hostname}-' $repopfad 